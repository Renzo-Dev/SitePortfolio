...
const cases = [
	{
		...
		problem:
			'Пользователи ждали до 3 секунд при фильтрации объектов с картами и сложными запросами к PostgreSQL',
		solution:
			'Внедрил Redis для кеширования геоданных, оптимизировал SQL-запросы и добавил индексы по координатам',
		result:
	...
	{
		title: 'От идеи до продакшена за 2 недели с Docker',
		problem:
			'Ручной деплой каждого обновления занимал 2-3 часа, часто возникали ошибки из-за различий в окружениях',
		solution:
			'Настроил Docker-контейнеризацию, создал CI/CD пайплайн в GitLab с автотестами и автодеплоем на staging/production',
		result:
			'Время деплоя сократилось до 8 минут, количество ошибок при обновлениях снизилось на 89%',
		takeaway:
			'Автоматизация DevOps освобождает время для разработки фич вместо борьбы с инфраструктурой',
		metrics: [
			{ start: 180, end: 8, label: 'Время деплоя (мин)', suffix: 'м' },
			{ start: 0, end: 89, label: 'Снижение ошибок (%)', suffix: '%' },
		],
	},
]
